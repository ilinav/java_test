...
public class TestBase {
  ...
  private boolean isIssueOpen(int issueId) throws IOException {
    ...
    Set<Issue> issues = new Gson().fromJson(parsed, new TypeToken<Set<Issue>>() {
    }.getType());
    Issue currentIssue = issues.iterator().next();
    String state = currentIssue.getState_name();
    String fixedState = "resolved";
    return !state.equals(fixedState);
  }
