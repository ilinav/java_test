...
public class DbConnectionsTest {
  ...
  public void testDbConnections() {
    ...
    try {
      ...
      conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/addressbook?useLegacyDatetimeCode=false&serverTimezone=Europe/Moscow&useSSL=false&user=root&password=");
